...
i=ImageTk.PhotoImage(Image.open('C:\\Users\\asus\\Desktop\\projects\\healthprediction\\images\\bgimage.jpg'))
l=Label(scr,image=i)
l.pack()
...
# FOR BACKGROUND IMAGE
i1=ImageTk.PhotoImage(Image.open('C:\\Users\\asus\\Desktop\\projects\\healthprediction\\images\\frame.jpg'))
