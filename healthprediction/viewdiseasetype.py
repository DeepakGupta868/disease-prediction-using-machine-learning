...
i=ImageTk.PhotoImage(Image.open('C:\\Users\\asus\\Desktop\\projects\\healthprediction\\images\\diseasetype.png'))
l=Label(scr,image=i)
l.pack()
...
loadimage1 = ImageTk.PhotoImage(Image.open('C:\\Users\\asus\\Desktop\\projects\\healthprediction\\images\\general.png'))
general =Button(image=loadimage1,width=220,height=41,command=gd)
general["bg"] = "white"
general["border"] = "5"
general.place(x=550,y=200)

loadimage2 = ImageTk.PhotoImage(Image.open('C:\\Users\\asus\\Desktop\\projects\\healthprediction\\images\\other.png'))
