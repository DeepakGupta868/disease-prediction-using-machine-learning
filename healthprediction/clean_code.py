...
def NaiveBayes():
    try:
        client=s.connect("C://Users//asus//Desktop//projects//healthprediction//register.db")
        cu=client.cursor()
...
i=ImageTk.PhotoImage(Image.open('C:\\Users\\asus\\Desktop\\projects\\healthprediction\\images\\png.png'))
...
#mic
mic=ImageTk.PhotoImage(Image.open('C:\\Users\\asus\\Desktop\\projects\\healthprediction\\images\\mic.jpg'))
microphone=Button(master=root,width=13,height=13,image=mic,relief='flat',command=SpeechRecog)
microphone.place(x=300,y=74)
#logout
logout=ImageTk.PhotoImage(Image.open('C:\\Users\\asus\\Desktop\\projects\\healthprediction\\images\\logoutbtn.jpg'))
