...
i=ImageTk.PhotoImage(Image.open('C:\\Users\\asus\\Desktop\\projects\\healthprediction\\images\\bgimage1.jpg'))
l=Label(scr,image=i)
l.pack()
...
# FOR BACKGROUND IMAGE
i2=ImageTk.PhotoImage(Image.open('C:\\Users\\asus\\Desktop\\projects\\healthprediction\\images\\gend.png'))
l2=Label(frame1,image=i2)
l2.pack()

# FOR BACKGROUND IMAGE
i3=ImageTk.PhotoImage(Image.open('C:\\Users\\asus\\Desktop\\projects\\healthprediction\\images\\otherpng.png'))
